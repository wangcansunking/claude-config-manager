...
![Dashboard 总览](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/01-dashboard-overview.png)
...
![MCP 使用图表](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/01b-dashboard-mcp-usage.png)

### 个性化推荐

针对当前配置运行 `/ccm-recommendations`，推荐你还没装的插件、MCP 服务器、skill。

![推荐](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/02-recommended.png)

### 插件管理

查看已安装的插件、浏览市场、进入插件详情查看它的命令、skill、MCP 服务器。

![已安装插件](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/03-config-plugins-installed.png)
![插件详情面板](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/03b-plugin-detail-panel.png)
![插件市场](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/03c-plugins-marketplace.png)

### MCP 服务器管理

添加、移除、查看 MCP 服务器。MCP 市场让你一键安装常用服务。

![已安装 MCP](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/04-config-mcp-installed.png)
![MCP 市场](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/04c-mcp-store.png)

### Skill、命令与设置

在全屏阅读器中编辑 skill markdown、管理 slash command、无需打开编辑器调整 `settings.json`（model、hooks、env var）。

![Skill 标签页](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/05-config-skills.png)
![设置标签页](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/07-config-settings.png)

### 配置档案（导出 / 导入 / 激活）

把完整配置 — 插件、MCP 服务器、skill、命令、hook、设置 — 快照到一个命名的配置档案里。切档案就切整套配置；导出成 `.json` 可分享给同事。

![配置档案](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/08-profiles.png)
![导出 / 导入](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/08b-profiles-export-import.png)

### 会话活动

跨所有项目浏览历史与正在运行的 Claude Code 会话。点击任意会话查看历史；一键复制 `claude --resume <id>` 恢复。

![活动](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/09-activity.png)
![会话详情](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/09b-activity-session-detail.png)

### 暗色 / 亮色主题

![暗色](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/10-dark-mode.png)
![亮色](https://raw.githubusercontent.com/wangcansunking/claude-config-manager/master/docs/migration/screenshots/10b-light-mode.png)

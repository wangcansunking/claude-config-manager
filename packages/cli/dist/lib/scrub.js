...
const SECRET_KEY_PATTERN = /key|token|password|secret|apikey|auth|bearer|credential|signature|private/i;
 ...
 */
export function findResidualSecrets(data) {
    const hits = [];
    sweep(data, [], hits);
    return hits;
}
function sweep(node, path, hits) {

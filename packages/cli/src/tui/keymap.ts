...
// labelKey values map to footer.* i18n keys.
// The Footer component resolves them via t() at render time.
export interface KeyHintDef { key: string; labelKey: string }

export const GLOBAL_HINT_DEFS: KeyHintDef[] = [
...
export const GLOBAL_HINTS: KeyHint[] = GLOBAL_HINT_DEFS.map((d) => ({
  key: d.key,

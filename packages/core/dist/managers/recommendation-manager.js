...
- Skills (${skills.length}): ${skills.slice(0, 10).map((s) => s.name).join(', ')}${skills.length > 10 ? '...' : ''}`;
    }
    /** Build the prompt for Claude to generate recommendations */
    buildPrompt(userContext, trendingData) {
...
//# sourceMappingURL=recommendation-manager.js.map